export default {
  ...
  plugins: {
    ...
    add: {
      ...
      descr: '⚙️ ¿Desarrollando un plugin nuevo? Agrégalo aquí para probarlo. No se guarda, al actualizar la página se borra de la memoria.',
  ...
  tips: {
    ...
    lines: [
      ...
      '¿Usas Slack y quieres ganar más tiempo? Prueba nuestro <a href="//xroom.app/en/library/slack-bot" target="_blank">bot de Slack</a>.',
      '¿Te pierdes las videollamadas de Telegram? Nuestro <a href="//xroom.app/en/library/telegram-bot" target="_blank">bot de Telegram</a> está para ayudarte.',
