export default {
  ...
  tips: {
    ...
    lines: [
      ...
      'Benützen Sie Slack und möchten Sie Zeit sparen? Probieren Sie unseren <a href="//about.xroom.app/en/library/slack-bot" target="_blank">Slack bot</a> aus.',
      'Vermissen Sie Video-Konferenzen in Telegram? Unser <a href="//about.xroom.app/en/library/telegram-bot" target="_blank">Telegram bot</a> steht Ihnen zur Verfügung.',
