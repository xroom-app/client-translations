export default {
  ...
  mbox: {
    ...
    doYouWantToLeave: 'Ви точно хочете вийти з вебінару?',
    doYouWantToLeaveAsHost: 'Ви точно хочете завершити стрім?',
    ...
    researchConsent: 'Привет! Мы сейчас ведём серьёзные работы по улучшению сервиса. Если вдруг встретите ошибку, не стесняйтесь сообщать на hello@xroom.app',
  },
  home: {
  ...
  pre: {
    ...
    roomIsBusyWebinar: 'Вже йде стрім/вебінар',
    roomIsBusyConference: 'Вже йде конференція',
    startWebinar: 'Запуск у режимі стріма/вебінара',
  },
  videoMenu: {
    hint: 'Меню',
    expand: 'Розширити',
