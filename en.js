module.exports = {
  ...
  mbox: {
    ...
    noPeers: 'Messages do not use xroom.app servers to send and cannot be redelivered after newly added guests connect. Please wait till others have joined the conversation to send messages. ',
