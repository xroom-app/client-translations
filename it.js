export default {
  ...
  mbox: {
    ...
    allowCameraPlz: 'Dopo aver premuto Ok per favore <b>dai il consenso</b> a xroom.app di usare la tua videocamera.<br><br>Non preoccuparti! Sarai in grado di spegnerla di nuovo prima di entrare nella stanza dal menu in basso, se vuoi rimanere non visibile.',
  ...
  home: {
    ...
    btnGo: 'Vai!',
    knowMore: 'Informazioni su xroom.app',
  ...
  pre: {
    ...
    roomBooked: 'Ci sarà un evento in questa sala presto: <b>%s</b>.',
  },
  videoMenu: {
  ...
  settings: {
    ...
    screenFace: 'Mostra la videocamera durante la condivisione dello schermo (BETA)',
