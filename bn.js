module.exports = {
  ...
  mbox: {
    notSupported: 'দেখে মনে হচ্ছে এই ব্রাউজারটি এই প্ল্যাটফর্মটি সমর্থন করে না বা WebRTC অক্ষম 😢',
    ...
    noPeersP2P: 'মেসেজ সেন্ড করার জন্য এর কোনো সার্ভার ব্যবহার করা হয় না এবং মিটিং এ নতুন কেও অংশগ্রহণ করার পর তাকে পুনরায় মেসেজ পাঠানো সম্ভব হবে না। মেসেজ পাঠানোর জন্য দয়াকরে নতুন কোনো অংশগ্রহণকারী মিটিং এ যোগ দেয়া পর্যন্ত অপেক্ষা করুন।',
