export default {
  ...
  mbox: {
    ...
    researchConsent: 'Zdråv! Provodimo råziskyvańje sětevogo kvaliteta.<br><br>Či možemo koristati dane ob kvalitetu tutogo svęzka?',
  },
  home: {
  ...
  pre: {
    ...
    roomIsBusyConference: 'Web-konferencija už ide',
    startWebinar: 'Načeti v režimu strim/webinar',
  },
  videoMenu: {
    hint: 'Phni menu',
    expand: 'Razširi',
