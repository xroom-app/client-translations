export default {
  ...
  mbox: {
    ...
    allowCameraPlz: 'После нажатия кнопки "ОК", пожалуйста, разрешите xroom использовать камеру. Не волнуйтесь, если вы не хотите, чтобы вас видели, то её можно будет без проблем выключить в меню снизу перед входом в комнату.',
