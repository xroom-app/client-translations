export default {
  ...
  mbox: {
    ...
    noSTUN: 'Упс, что-то с сетью. Возможно, это файрвол, а может соединение отвалилось. Попробуйте с другим подключением. Вот, кстати, <a href="https://xroom.app/en/blog/2020-08-07-experiencing-network-or-connection-issues" target="_blank">полезная статья</a> на эту тему.',
  },
  notify: {
