export default {
  ...
  plugins: {
    ...
    add: {
      ...
      descr: '⚙️ Разрабатываешь плагин? Добавь его здесь для тестирования. Он сохранится только в этом браузере. Документация на API для плагинов доступна <a href="https://github.com/xroom-app/client-plugins" target="_blank">вот тут</a>.',
