module.exports = {
  ...
  mbox: {
    ...
    noPeers: 'Поскольку мы не касаемся пользовательских данных, то и переслать мы их сами не можем. Вы должны сделать это online, когда кто-нибудь появится в чате.',
  ...
  controls: {
    ...
    invite: 'Пригласить',
    ss: 'Показывать экран ("s")',
    stopSharing: 'Не показывать экран ("s")',
    board: 'Доска',
    hand: 'Поднять руку',
    lock: 'Защита',
    layouts: 'Размещение',
