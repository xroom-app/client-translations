export default {
  ...
  mbox: {
    ...
    researchConsent: 'Привет! Мы проводим исследования качества сетей.<br><br>Можно ли нам использовать данные по качеству этого соединения?',
  },
  home: {
  ...
  tips: {
    ...
    lines:[
      ...
      'Если вам нужно что-либо рисовать во время звонка, попробуйте плагин "Sketcher". Не забывайте, разумеется, расшаривать экран.',
    ]
  },
}
