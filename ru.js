export default {
  ...
  mbox: {
    ...
    cannotFile: 'Поскольку мы не касаемся пользовательских файлов, то мы и переслать их не можем Вы должны сделать это online, когда кто-нибудь поавится в чате.',
    cannotMessage: 'Поскольку мы не касаемся пользовательских сообщений, то мы и переслать их не можем Вы должны сделать это online, когда кто-нибудь поавится в чате.',
